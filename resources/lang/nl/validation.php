...
return [
    ...
    */
    ...
    'attributes' => [
        'testimonial-title' => 'getuigenistitel',
        'testimonial-body' => 'Getuigenis tekst',
        'sight-name' => 'Bezienswaardigheid naam',
        'sight-description' => 'Bezienswaardigheid beschrijving',
        'sight-address' => 'Bezienswaardigheid adres',
        'sight-email' => 'Bezienswaardigheid e-mail',
        'sight-tel' => 'Bezienswaardigheid telefoonnummer',
        'password' => 'wachtwoord',
        'password_confirmation', 'wachtwoord bevestiging',
        'school-name' => 'School naam',
        'school-description' => 'School beschrijving',
        'opleiding-naam' => 'Opleiding naam',
        'opleiding-beschrijving' => 'Opleiding beschrijving',
        'opleiding-link' => 'Opleiding link',
        'link-name' => 'Link naam',
